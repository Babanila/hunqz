...
describe('renderTargetAge', () => {
  it('renders min and max correctly', () => {
    expect(
      renderTargetAge(25, 35),
    ).toBe('25 - 35');
  });

  it('renders missing min correctly', () => {
    expect(
      renderTargetAge(undefined, 35),
    ).toBe('- - 35');
  });

  it('renders missing max correctly', () => {
    expect(
      renderTargetAge(25, undefined),
    ).toBe('25 - -');
  });
